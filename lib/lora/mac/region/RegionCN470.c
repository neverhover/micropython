...
bool RegionCN470RxConfig( RxConfigParams_t* rxConfig, int8_t* datarate )
{
    ...
    printf("Radio setRXconfig freq:%d mod:%d, bw:%d, dr:%d, timeout:%d, rx_conti:%d\r\n",
        frequency, MODEM_LORA, rxConfig->Bandwidth, phyDr, rxConfig->WindowTimeout, rxConfig->RxContinuous);
